		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NR VS Code",
									"targetURL": "#comsystemfoxnrpnr1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsystemfoxnrpnr1-display": {
								"semanticObject": "comsystemfoxnrpnr1",
								"action": "display",
								"description": "VS Code",
								"title": "NR VS Code",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.systemfox.nr.pnr1",
									"url": sap.ui.require.toUrl("com/systemfox/nr/pnr1")
								}
							}
						}
					}
